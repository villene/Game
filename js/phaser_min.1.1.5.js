...
!function (a, b) {
    ...
    b.WebGLRenderGroup.prototype.handleFilterBlock = function (a, c) {
        ...
        switch (a.type) {
            ...
            case"audio":
                ...
                break;
            case"tilemap":
                if (this._xhr.open("GET", this.baseURL + a.url, !0), this._xhr.responseType = "text", a.format === c.Tilemap.TILED_JSON)this._xhr.onload = function () {
    ...
    return c.Physics = {}, c.Physics.Arcade = function (a) {
        ...
        if (this._mapData = b.getTiles(a.body.left, a.body.top, a.body.width, a.body.height, !0), 0 !== this._mapData.length)if (this._mapData.length > 1)this.separateTiles(a.body, this._mapData); else {
            var f = 0;
            this.separateTile(a.body, this._mapData[f]) && (d ? d.call(e, a, this._mapData[f]) && (this._total++, c && c.call(e, a, this._mapData[f])) : (this._total++, c && c.call(e, a, this._mapData[f])))
        }
        ...
        var c = !1;
        (a.width <= 0 || a.height <= 0 || b.width <= 0 || b.height <= 0) && (c = !1), c = !(a.right < b.left || a.bottom < b.top || a.left > b.right || a.top > b.bottom), !c && a.inContact(b) && a.removeContact(b)
    ...
    }, separateTiles: function (a, b) {
        for (var c, d = !1, e = 0; e < b.length; e++)c = b[e], this.separateTile(a, c) && (d = !0);
        return d
        ...
        this.add(b.overlapV), this.rebound && (this.processRebound(a), this.reboundCheck(!0, !0, !1), a.reboundCheck(!0, !0, !1))
    }, take: function (a, b) {
        this.sub(b.overlapV), this.rebound && (this.processRebound(a), this.reboundCheck(!0, !0, !1), a.reboundCheck(!0, !0, !1))
    }, split: function (a, b) {
    ...
    }, processRebound: function (a) {
        this._vx <= 0 && this.velocity.x > 0 || this._vx >= 0 && this.velocity.x < 0 || (this.velocity.x = a.velocity.x - this.velocity.x * this.bounce.x), this._vy <= 0 && this.velocity.y > 0 || this._vy >= 0 && this.velocity.y < 0 || (this.velocity.y = a.velocity.y - this.velocity.y * this.bounce.y), this.angle = Math.atan2(this.velocity.y, this.velocity.x), this.reboundCheck(!0, !0, !1)
        ...
        for (var q = [], e = 0; e < a.tilesets.length; e++) {
            ...
            r.tileproperties && (s.tileProperties = r.tileproperties), s.rows = (r.imageheight - r.margin) / (r.tileheight + r.spacing), s.columns = (r.imagewidth - r.margin) / (r.tilewidth + r.spacing), s.total = s.rows * s.columns, q.push(s)
        }
